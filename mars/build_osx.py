...
OSX_BUILD_ARM_CMD = 'cmake ../.. -DCMAKE_OSX_DEPLOYMENT_TARGET:STRING=11.0 -DCMAKE_BUILD_TYPE=Release -DENABLE_ARC=0 -DENABLE_BITCODE=0 -DCMAKE_OSX_ARCHITECTURES="arm64" && make -j8 && make install'

OSX_BUILD_X86_CMD = 'cmake ../.. -DCMAKE_OSX_DEPLOYMENT_TARGET:STRING=11.0 -DCMAKE_BUILD_TYPE=Release -DENABLE_ARC=0 -DENABLE_BITCODE=0 -DCMAKE_OSX_ARCHITECTURES="x86_64" && make -j8 && make install'
